...
10. [Generate rand7 using rand5](https://github.com/harishvc/challenges/blob/master/generate-rand7.py) :bulb:    
...
11. Given denominations and a total   
    ...
    11.3 [Find all possible combinations to reach a total using lookup](https://github.com/harishvc/challenges/blob/master/coin-change-with-lookup.py) :bulb: :boom:  
...
19. Input string and dictionary of words     
   19.1 [Can the input word be split using space-separated sequence of dictionary words?](https://github.com/harishvc/challenges/blob/master/word-break.py) :notes:  :art:        
