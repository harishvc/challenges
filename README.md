...
11. Given a list and condition  
   ...
   11.6 [Find three numbers when multipled provide max value](https://github.com/harishvc/challenges/blob/master/find-three-numbers-when-multipled-provide-max-value.py)  
