...
19. Find the shortest path between two nodes in a binary tree [solution 1: Using LCA]  [solution 2: Using root to node path](https://github.com/harishvc/challenges/blob/master/binary-tree-shortest-path2.py) :thumbsup: :notes: :rocket:
