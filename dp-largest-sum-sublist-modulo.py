#Find #occurances of the largest sum contiguous subarray of modulo K


'''
Modify Kadane algorithm to keep track of #occurences.
...
def maxContiguousSum(a,K):
	sum_so_far =0
	max_sum = 0
	count = {} #keep track of occurences
...
print("input >>> %s max sum=%d #occurences=%d" % (a,max_sum,count))
