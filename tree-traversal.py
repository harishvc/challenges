#BINARY TREES
#1. Each node can no more than 2 child node
#2. Value of the left child node is less than the value of the right child node
#3. Value of the left and right child node is less than the parent node
...
#Time complexity is O(n) where n is number of nodes. Each node is visited exactly once.
print "#preorder >>> ",
